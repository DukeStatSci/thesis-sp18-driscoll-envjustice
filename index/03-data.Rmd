...
Data cleaning was done with R using the DBI and SQLite packages [@dbi; @rsqlite]. Since there is so much data, it's not feasible to process it using typical R functions, so we used a SQL database. This significantly speeds up the processes detailed below.
