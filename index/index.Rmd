...
hisp_data = rbind.fill(p1990, p1991, p1992, p1993, p1994, p1996, p1997, p1998, p1999, p2000, p2001, p2002, p2003, p2005, p2006, p2007, p2008, p2009, p2010)
hisp_data$other_full = rowSums(hisp_data[, c(5:7, 12:13)], na.rm = TRUE)
hisp_data = select(hisp_data, id, pop, white, black, hispanic, other_full, concentration, area, year)
names(hisp_data) = c("id", "pop", "white", "black", "hispanic", "other", "concentration", "area", "year")
```
