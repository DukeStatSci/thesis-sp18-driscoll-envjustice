...
RSEI data is extremely fine-grained, however it contains many inconsistencies over time, and needs to be aggregated to the census geography. By aggregating RSEI data, we are able to calculate toxicity measures for each block group. In combination with the census data, this allows us to estimate distributions of toxicity experienced by minority groups in the United States. Additionally, we are able to analyze macro level trends over time, such as the overall geography of toxicity in America, how the 5th, 50th, and 95th percentiles of toxicity experienced by each race group varies over time, and how protective higher incomes are for each race group. 
