...
Improving on past binary measures of pollution exposure, with data on an extended time period, we are able to broach more systematic questions. Combining RSEI toxicity data with Census demographic data, we create empircal distributions of toxicity experienced by the American public in order to examine: the overall geography of toxicity in America; how the 5th, 50th, and 95th percentiles of toxicity experienced by each race group varies over time; and how protective higher incomes are for each race group. Through creating toxicity distributions for minority and low-income groups over the 23 year period, we are able to see how toxicity burdens change over time. 
