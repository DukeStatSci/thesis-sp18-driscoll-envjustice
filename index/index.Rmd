...
The results are incorporated into a publicly available app that allows users to investigate toxicity in their area relative to the U.S. at large, and investigate the differences in local racial toxicity burden.
