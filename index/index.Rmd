...
RSEI data is released under The Emergency Planning and Community Right-to-Know Act (EPCRA,) and contains data that would be incredibly useful to communities, but is incredibly intricate and complex. These results are incorporated in to a publicly available app that allows users to investigate toxicity in their area relative to the US, and investigate the differences in racial toxicty burden.
