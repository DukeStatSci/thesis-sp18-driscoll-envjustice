...
g = ggplot() + geom_density(aes(concentration, weight = white/sum(white), color = "County"), bw = 0.07, data = county2010)
g = g + geom_density(aes(concentration, weight = white/sum(white), color = "State"), bw = .15, data = state2010)
g = g + geom_density(aes(concentration, weight = white/sum(white), color = "Block Group"), bw = 0.1, size = 1, data = bg2010)
