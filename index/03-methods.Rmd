...
create_group_tox = function(cur_data, se, perc) {
  ...
  labs(x = "Year", y = paste0(perc, "th Percentile Group Toxicity"), fill = "Legend") + guides(color = FALSE)
}
...
create_relative_tox = function(data, perc) {
  ggplot(data) + 
    ...
    labs(x = "Year", y = paste0("Group ", perc, "th Percentile Toxicity Relative to White Distribution"), colour = "Legend") 
}
...
create_pov_tox = function(cur_data, perc) {
  ...
  labs(x = "Year", y = paste0(perc, "th Percentile Group Toxicity"), color = "Legend")
}
