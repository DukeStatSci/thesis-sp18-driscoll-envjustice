...
We use bootstrap sampling to approximate the standard errors of the simulated estimates of the 5th, 50th and 95th quantiles with different values for n. This sampling helps us to choose a size of the sample to get an accurate measure, and frames the final values we report. 

```{r simulationSE, echo = FALSE, warning = FALSE, message = FALSE, fig.width=8, fig.height=4}
...
ggplot() + 
  ...
  labs(x = "Size of simulated group", y = "Simulated 5th Percentile", title = "Variance of Simulation 5th Percentile")

ggplot() + 
  geom_ribbon(aes(x = n, ymin = mean-sd, ymax = mean+sd), alpha=0.2, data = sim_50) +
  geom_line(aes(x = n, y = mean), data = sim_50) +
  labs(x = "Size of simulated group", y = "Simulated 50th Percentile", title = "Variance of Simulation 50th Percentile")

ggplot() + 
  geom_ribbon(aes(x = n, ymin = mean-sd, ymax = mean+sd), alpha=0.2, data = sim_95) +
  geom_line(aes(x = n, y = mean), data = sim_95) +
  labs(x = "Size of simulated group", y = "Simulated 95th Percentile", title = "Variance of Simulation 95th Percentile")
```
