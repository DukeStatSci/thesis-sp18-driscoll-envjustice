...
sim_tox = function(cur_data, perc, legend = FALSE, smooth = FALSE) {
  ...
  if (smooth == TRUE) {
    g = g +
      ...
      geom_line(aes(x = year, y = rollmean(black, 3, na.pad=TRUE), color = "black"), se = FALSE, size = 0.5)  +
      geom_line(aes(x = year, y = rollmean(hispanic, 3, na.pad = TRUE), color = "hispanic"), se = FALSE, size = 0.5) +
      geom_line(aes(x = year, y = rollmean(other, 3, na.pad = TRUE), color = "other"), se = FALSE, size = 0.5) +
      geom_line(aes(x = year, y = rollmean(white, 3, na.pad = TRUE), color = "white"), se = FALSE, size = 0.5)
  } 
  else {
     g = g +
      geom_line(aes(x = year, y = white, color = "white")) +
  ...
  g = g + geom_line(aes(x = year, y = sim_b, color = "black")) + 
  g
}
```
