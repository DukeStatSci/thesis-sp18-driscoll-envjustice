...
By adding additional block level data to this regression, and testing model fit more rigorously, we may be able to discuss the magnitude of toxicity differences that are attributable to race, and will be more informed on the other factors that hold importance in predicting toxicity. 
