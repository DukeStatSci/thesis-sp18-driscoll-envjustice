...
plot_quant(exp(predict.rq(quant_tri_den, test)))
plot_quant(exp(predict.rq(quant_tri, test)))
plot_quant(exp(predict.rq(quant_lin, test)))
plot_quant(exp(predict.rq(quant_den, test)))
plot_quant(exp(predict.rq(quant, test)))
```
