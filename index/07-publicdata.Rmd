...
A choropleth map forms the centerpiece of the app, showing the average toxicity of counties in the area surrounding the point. This contextualizes the toxicity, which is unitless and only interpretable in comparison to other toxicites. Choropleth maps are a familiar form of communicating location based data. 
