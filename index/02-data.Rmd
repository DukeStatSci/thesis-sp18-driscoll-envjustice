...
* The RSEI data is self reported, and has been thought to contain some severe underreporting. (De Marchi and Hamilton, 2006)

* The data is entirely based off a black box fate and transport model. The model has uncertainty that is not reported in RSEI and therefore is not being addressed. 
